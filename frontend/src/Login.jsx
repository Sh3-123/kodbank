    ...
    return (
        <div className="flex min-h-screen bg-background text-white font-sans w-full overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#1a1c23] to-[#14291e] overflow-hidden items-center justify-center p-12 lg:p-24">
                {/* Decorative Elements - Green theme replacing purple/orange */}
            ...
            {/* Right Panel (Form) */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 bg-background relative z-10 lg:shadow-[-20px_0_50px_rgba(0,0,0,0.5)]">
                <div className="w-full max-w-md">
                    <h2 className="text-2xl font-bold mb-10 text-center text-accent tracking-wide uppercase">USER LOGIN</h2>
                    ...
                    <p className="mt-12 text-center text-sm text-textMuted font-medium">
                        Don't have an account? <Link to="/register" className="text-accent hover:text-accentDark transition-colors ml-1">Register</Link>
                    </p>
                </div>
            </div>
        </div>
